...
enum
{
  ...
  MTYPE_ISIS_NEXTHOP,
  MTYPE_ISIS_NEXTHOP6,
  MTYPE_ISIS_EXTERNAL_INFO,
  MTYPE_SISIS,
  MTYPE_SISIS_LISTENER,
  MTYPE_SHIM,
  MTYPE_SHIM_SISIS_LISTENER,
  MTYPE_ROSPF6_SHIM_MESSAGE,
  MTYPE_SHIM_IF,
  MTYPE_VTYSH_CONFIG,
...
extern struct memory_list memory_list_sisis[];
extern struct memory_list memory_list_shim[];
