...
extern int shim_sendmsg (struct in6_addr * src, struct in6_addr * dst, unsigned int * ifindex, struct iovec * message, unsigned int fd, struct stream * buf, unsigned int len);
